<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="surveillance_des_examens.userprofile" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/181_schedule-timetable-calendar-date-512.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Your exams supervision schedule</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Your schedule info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
